...
- This app is also made with the [ciro23/mvc-framework library](https://github.com/Ciro23/mvc-framework), install it with: composer require ciro23/mvc-framework.
